...
def componententer(comp_number):                #Text box call functionality
    ...
    if comp_number == 1:
        ...
        writeLinkToRow(calcform.component_4)
        populateFields(calcform.component_4, calcform.price_4)

    elif comp_number == 5:
        writeLinkToRow(calcform.component_5)
        populateFields(calcform.component_5, calcform.price_5)

    elif comp_number == 6:
        writeLinkToRow(calcform.component_6)
        populateFields(calcform.component_6, calcform.price_6)

    elif comp_number == 7:
        writeLinkToRow(calcform.component_7)
        populateFields(calcform.component_7, calcform.price_7)

    elif comp_number == 8:
        writeLinkToRow(calcform.component_8)
        populateFields(calcform.component_8, calcform.price_8)

    elif comp_number == 9:
        writeLinkToRow(calcform.component_9)
        populateFields(calcform.component_9, calcform.price_9)

    elif comp_number == 10:
        writeLinkToRow(calcform.component_10)
